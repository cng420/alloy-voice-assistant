...
class Assistant:
    ...
    def answer(self, prompt, image):
        ...
        response = self.chain.invoke(
            ...
            config={"configurable": {"session_id": self.user_id}}).strip()
    ...
    def _create_inference_chain(self, model):
        ...
        return RunnableWithMessageHistory(chain, lambda _: self.chat_message_history,
                                           input_messages_key="prompt", history_messages_key="chat_history")
